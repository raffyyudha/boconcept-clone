...
INSERT INTO services (title, category, image, description, features, sort_order) VALUES
  ...
  ('Premium Flooring & WallPanel', 'Interior Surfaces', '/premium_flooring_wallpanel.png', 'Ultra-durable, water-resistant vinyl flooring and modern fluted wall panels. Give your home a luxury backdrop with low maintenance and heavy-duty wear resistance built to last for decades.', '["Waterproof & termite-free vinyl", "Textured fluted wall panels", "Quick overlays and installation", "Eco-friendly, zero formaldehyde"]', 4),
