...
INSERT INTO catalogue_products (name, image, description, features, sort_order) VALUES
  ...
  ('Commercial Roller Blinds', '/catalogue/commercial-roller-blinds.avif', 'Heavy-duty, functional window shades built to withstand the demands of workspaces, storefronts, and commercial offices. Fabricated using flame-retardant materials that reflect glare while maintaining work visibility.', '["Fire-retardant certified", "Anti-glare screen meshes", "Easy chain-pulley lock system", "Ultra-durable hardware"]', 7),
  ('Sliding Honeycomb Blinds', '/catalogue/sliding-honeycomb-blinds.avif', 'A modern cellular blind system on a horizontal sliding track, ideal for sliding doors and room dividers. The unique honeycomb pockets trap air to create an active thermal barrier, keeping your indoor space cool.', '["Horizontal sliding track", "Cellular thermal insulation", "Sound-absorbing structure", "Neat, fold-away profile"]', 8),
  ('Day & Night Blackout Honeycomb Sliding Blind', '/catalogue/day-night-blackout-honeycomb-sliding-blind.avif', 'An advanced dual-action sliding cellular blind. Features a sheer honeycomb side for daytime light filtering and a fully lined blackout honeycomb side for total night privacy and maximum insulation.', '["Dual-phase day/night glide", "Maximum energy efficiency", "Complete blockout lining", "Sleek aluminum frame tracks"]', 9),
...
INSERT INTO services (title, category, image, description, features, sort_order) VALUES
  ...
  ('Premium Flooring & WallPanel', 'Interior Surfaces', '/premium_flooring_wallpanel.avif', 'Ultra-durable, water-resistant vinyl flooring and modern fluted wall panels. Give your home a luxury backdrop with low maintenance and heavy-duty wear resistance built to last for decades.', '["Waterproof & termite-free vinyl", "Textured fluted wall panels", "Quick overlays and installation", "Eco-friendly, zero formaldehyde"]', 4),
