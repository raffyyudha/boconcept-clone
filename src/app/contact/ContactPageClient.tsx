          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div>
                ...
                <span className="text-lg font-serif text-white group-hover:text-[#d4af37] transition-colors">Alvin Lim: +65 {whatsappNumber.replace('65', '').replace(/(\d{4})(\d{4})/, '$1 $2')}</span>
            ...
            >
              ...
              <div>
                ...
                <span className="text-base font-serif text-white group-hover:text-[#d4af37] transition-colors">{email}</span>
            ...
            >
              ...
              <div>
                ...
                <span className="text-base font-serif text-white group-hover:text-[#d4af37] transition-colors">{addressLine1}</span>
                <span className="text-xs text-[#8b8c8b] block mt-1">{addressLine2} (By Appointment Only)</span>
              </div>
            </a>
            ...
            >
              <div className="w-12 h-12 bg-white p-1 flex items-center justify-center shrink-0 border border-neutral-800">
                <img src={websiteQr} alt="Website QR Code" className="w-full h-full object-contain" />
              </div>
              <div>
          ...
          <div className="space-y-4">
            {faqs.map((faq: any, index: number) => (
              ...
              >
                ...
                >
                  <span className="text-sm font-serif text-white">{faq.question}</span>
                  <ChevronDown
                    size={16}
